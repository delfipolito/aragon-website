...
/******/ 	__webpack_require__.p = "https://delfipolito.github.io/aragon-website/";
/******/
...
var LCard = function LCard(_ref) {
  ...
  return _react2.default.createElement(
    ...
    props.image && props.textAlign == 'right' && _react2.default.createElement(
      ImageContainer,
      { className: 'image-container right-container' },
      _react2.default.createElement(
        _Fade2.default,
    ...
    _react2.default.createElement(
      'div',
      { className: props.textAlign + '-box text-box' },
    ...
    props.image && props.textAlign == 'left' && _react2.default.createElement(
      ImageContainer,
      { className: 'image-container left-container' },
      _react2.default.createElement(
        _Fade2.default,
...
var Card = function Card(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _ui.BreakPoint,
      { to: 'medium' },
      _react2.default.createElement(LCard, props)
    ),
    _react2.default.createElement(
      _ui.BreakPoint,
      { from: 'medium' },
...
var LongFade = _styledComponents2.default.div(_templateObject, medium('height: 500px '));

var LongCard = (0, _styledComponents2.default)('div')(_templateObject2, function (props) {
  return props.background && 'background-image: url(' + props.background + ');';
}, function (props) {
  return props.gradient && 'background-image:' + props.gradient + ';';
}, medium('padding: 30px 15px;'), large('padding: 30px 60px;'), medium('flex-direction: row;'), medium('height: 500px '), medium('grid-column-end: 3;'), medium('margin-left: 20px;'), medium('margin-right: 20px;'), medium('justify-content: flex-end'), function (props) {
...
var ImageContainer = (0, _styledComponents2.default)('div')(_templateObject3, medium('width: 50%;'), medium('height: 430px;'));
...
console.log((0, _ui.breakpoint)('medium'));
var SCard = function SCard(_ref) {
  var props = _objectWithoutProperties(_ref, []);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('img', { src: __webpack_require__(192)("./" + props.imageUrl + '.svg') }),
    props.label && _react2.default.createElement(
      'div',
      { className: 'label' },
      _react2.default.createElement(
...
var Card = function Card(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _ui.BreakPoint,
      { to: 'medium' },
      _react2.default.createElement(SCard, props)
    ),
    _react2.default.createElement(
      _ui.BreakPoint,
      { from: 'medium' },
...
var SmallCard = _styledComponents2.default.div(_templateObject, function (props) {
  return props.background && 'background-image: url(' + props.background + ');';
}, function (props) {
  return props.gradient && 'background-image:' + props.gradient + ';';
}, function (props) {
  return props.textAlign == 'left' ? 'flex-start' : 'center';
}, medium('padding: 15px;'), large('padding: 30px 60px;'), function (props) {
  return props.cardHeight ? props.cardHeight : '500px';
}, function (props) {
  return props.imageBig && 'height: auto;';
}, function (props) {
  return props.imageBig && 'width: 100%;';
}, function (props) {
  return props.colorWhite ? '#b4b5cc' : '#7f8198';
}, function (props) {
  return props.textAlign ? props.textAlign : 'center';
}, medium('font-size: 36px; width: 100%;'), large('width: inherit; font-size: 46px;'), function (props) {
  return props.textAlign ? props.textAlign : 'center';
}, function (props) {
  return props.colorWhite ? 'white' : '#2d4051';
});
...
var map = {
	"./": 8,
	"./Bella/Features": 37,
	"./Bella/Features.js": 37,
	"./Bella/LastFeatures": 70,
	"./Bella/LastFeatures.js": 70,
	"./Bella/MoreFeatures": 71,
	"./Bella/MoreFeatures.js": 71,
	"./Bella/TryBella": 72,
	"./Bella/TryBella.js": 72,
	"./Bella/Video": 73,
	"./Bella/Video.js": 73,
	"./Bella/assets/1.svg": 118,
	"./Bella/assets/2.svg": 119,
	"./Bella/assets/3.svg": 120,
	"./Bella/assets/4.svg": 121,
	"./Bella/assets/5.svg": 122,
	"./Bella/assets/6.svg": 123,
	"./Bella/assets/7.svg": 124,
	"./Bella/assets/8.svg": 125,
	"./Bella/assets/arrow.svg": 38,
	"./Bella/assets/background-1.png": 193,
	"./Bella/assets/background-2.png": 194,
	"./Bella/assets/background-3.png": 195,
	"./Bella/assets/bg_2.png": 196,
	"./Bella/assets/hello.svg": 126,
	"./Bella/assets/hero-background.jpg": 154,
	"./Bella/assets/hero-title.svg": 15,
	"./Bella/assets/play.svg": 39,
	"./Bella/assets/promo-video.mp4": 150,
	"./Bella/assets/video-background.png": 151,
	"./Discover/About": 74,
	"./Discover/About.js": 74,
	"./Discover/BlogPost": 75,
	"./Discover/BlogPost.js": 75,
	"./Discover/Hero": 76,
	"./Discover/Hero.js": 76,
	"./Discover/Product": 77,
	"./Discover/Product.js": 77,
	"./Discover/UnstoppableOranizations": 78,
	"./Discover/UnstoppableOranizations.js": 78,
	"./Discover/assets/background-discover1.png": 197,
	"./Discover/assets/background-discover2.png": 198,
	"./Discover/assets/background-discover3.png": 199,
	"./Discover/assets/background-discover4.png": 200,
	"./Discover/assets/discover-video.mp4": 155,
	"./Discover/assets/discover1.svg": 127,
	"./Discover/assets/discover2.svg": 128,
	"./Discover/assets/discover3.svg": 129,
	"./Discover/assets/discover4.svg": 130,
	"./Discover/assets/discover5.svg": 131,
	"./Discover/assets/discover6.svg": 132,
	"./Discover/assets/discover7.png": 201,
	"./Discover/assets/poster.jpg": 35,
	"./Discover/assets/quote1.png": 202,
	"./Discover/assets/quote2.png": 203,
	"./Discover/assets/unstoppable-org-background.png": 156,
	"./Discover/assets/unstoppable-org.svg": 40,
	"./General/Card": 9,
	"./General/Card.js": 9,
	"./General/LongCard": 6,
	"./General/LongCard.js": 6,
	"./General/Quote": 79,
	"./General/Quote.js": 79,
	"./General/Section": 3,
	...
	"./Governance/About": 80,
	"./Governance/About.js": 80,
	"./Governance/Entry": 81,
	"./Governance/Entry.js": 81,
	"./Governance/Hero": 82,
	"./Governance/Hero.js": 82,
	"./Governance/Modules": 83,
	"./Governance/Modules.js": 83,
	"./Governance/Timeline": 84,
	"./Governance/Timeline.js": 84,
	"./Governance/TimelineContainer": 85,
	"./Governance/TimelineContainer.js": 85,
	"./Governance/assets/about.svg": 42,
	"./Governance/assets/buy.png": 158,
	"./Governance/assets/create.png": 159,
	"./Governance/assets/hero.png": 157,
	"./Governance/assets/stage1.svg": 43,
	"./Governance/assets/stage2.svg": 44,
	"./Governance/assets/stage3.svg": 45,
	"./Governance/assets/stage4.svg": 46,
	"./Governance/assets/stage5.svg": 47,
	"./Governance/assets/what.svg": 48,
	"./Home/About": 36,
	"./Home/About.js": 36,
	"./Home/Hero": 32,
	"./Home/Hero.js": 32,
	"./Home/home-assets/background-home1.png": 204,
	"./Home/home-assets/blur.png": 205,
	"./Home/home-assets/blur2.png": 117,
	"./Home/home-assets/fight-background.svg": 133,
	"./Home/home-assets/home-video.mp4": 33,
	"./Home/home-assets/home1.svg": 134,
	"./Home/home-assets/home2.svg": 135,
	"./Home/home-assets/home3.svg": 136,
	"./Home/home-assets/home4.svg": 137,
	"./Home/home-assets/home5.png": 206,
	"./Home/home-assets/poster.png": 207,
	"./Home/home-assets/video-mobile.mp4": 34,
	"./Network/NetworkContent": 86,
	"./Network/NetworkContent.js": 86,
	"./Network/assets/network-background.png": 160,
	"./Network/assets/network1.svg": 138,
	"./Network/assets/network2.svg": 139,
	"./Network/assets/network3.svg": 140,
	"./Network/assets/network4.svg": 141,
	"./Page/Footer": 26,
	"./Page/Footer.js": 26,
	"./Page/MenuItem": 21,
	"./Page/MenuItem.js": 21,
	"./Page/MenuPanel": 22,
	"./Page/MenuPanel.js": 22,
	"./Page/Navbar": 20,
	"./Page/Navbar.js": 20,
	"./Page/Page": 19,
	"./Page/Page.js": 19,
	"./Page/SidePanel": 23,
	"./Page/SidePanel.js": 23,
	"./Page/assets/close.svg": 24,
	"./Page/assets/forum.png": 116,
	"./Page/assets/ghost.svg": 29,
	"./Page/assets/logo-footer.svg": 27,
	"./Page/assets/logo.svg": 14,
	"./Page/assets/menu.svg": 25,
	"./Page/assets/rocket.svg": 30,
	"./Page/assets/twitter.svg": 28,
	"./Page/assets/youtube.svg": 31,
	"./Powered/Footer": 87,
	"./Powered/Footer.js": 87,
	"./Powered/Governance": 88,
	"./Powered/Governance.js": 88,
	"./Powered/Hero": 89,
	"./Powered/Hero.js": 89,
	"./Powered/MenuItem": 91,
	"./Powered/MenuItem.js": 91,
	"./Powered/MenuPanel": 92,
	"./Powered/MenuPanel.js": 92,
	"./Powered/Navbar": 90,
	"./Powered/Navbar.js": 90,
	"./Powered/PreFooter": 94,
	"./Powered/PreFooter.js": 94,
	"./Powered/Projects": 95,
	"./Powered/Projects.js": 95,
	"./Powered/Security": 96,
	"./Powered/Security.js": 96,
	"./Powered/SidePanel": 93,
	"./Powered/SidePanel.js": 93,
	"./Powered/Transparency": 97,
	"./Powered/Transparency.js": 97,
	"./Powered/assets/althea.svg": 49,
	"./Powered/assets/close.svg": 50,
	"./Powered/assets/dapp.svg": 51,
	"./Powered/assets/forum.png": 161,
	"./Powered/assets/ghost.svg": 52,
	"./Powered/assets/governance.svg": 53,
	"./Powered/assets/hero-bg.svg": 54,
	"./Powered/assets/hero-mobile.svg": 55,
	"./Powered/assets/logo-footer.svg": 56,
	"./Powered/assets/logo.svg": 16,
	"./Powered/assets/melonport.svg": 57,
	"./Powered/assets/menu.svg": 58,
	"./Powered/assets/pando.svg": 59,
	"./Powered/assets/pre-footer.svg": 60,
	"./Powered/assets/rocket.svg": 61,
	"./Powered/assets/security.svg": 62,
	"./Powered/assets/transparency.svg": 63,
	"./Powered/assets/twitter.svg": 64,
	"./Powered/assets/youtube.svg": 65,
	"./Project/About": 98,
	"./Project/About.js": 98,
	"./Project/AragonClient": 99,
	"./Project/AragonClient.js": 99,
	"./Project/AragonNetwork": 100,
	"./Project/AragonNetwork.js": 100,
	"./Project/Association": 101,
	"./Project/Association.js": 101,
	"./Project/ContributeContent": 102,
	"./Project/ContributeContent.js": 102,
	"./Project/Entry": 18,
	"./Project/Entry.js": 18,
	"./Project/FeedbackModule": 103,
	"./Project/FeedbackModule.js": 103,
	"./Project/GovernanceContent": 162,
	"./Project/GovernanceContent.js": 162,
	"./Project/GrantsContent": 104,
	"./Project/GrantsContent.js": 104,
	"./Project/GrantsQuotes": 105,
	"./Project/GrantsQuotes.js": 105,
	"./Project/SecondaryNavbar": 12,
	"./Project/SecondaryNavbar.js": 12,
	"./Project/assets/Aracon": 111,
	"./Project/assets/Aracon.js": 111,
	"./Project/assets/Blog": 110,
	"./Project/assets/Blog.js": 110,
	"./Project/assets/Contribute": 108,
	"./Project/assets/Contribute.js": 108,
	"./Project/assets/Governance": 106,
	"./Project/assets/Governance.js": 106,
	"./Project/assets/Grants": 107,
	"./Project/assets/Grants.js": 107,
	"./Project/assets/Roadmap": 109,
	"./Project/assets/Roadmap.js": 109,
	"./Project/assets/Wiki": 112,
	"./Project/assets/Wiki.js": 112,
	"./Project/assets/association.svg": 66,
	"./Project/assets/community-background.png": 163,
	"./Project/assets/contribute-background1.png": 208,
	"./Project/assets/contribute1.svg": 142,
	"./Project/assets/contribute2.svg": 143,
	"./Project/assets/contribute3.svg": 144,
	"./Project/assets/governance-background.png": 164,
	"./Project/assets/governance1.svg": 145,
	"./Project/assets/governance2.svg": 146,
	"./Project/assets/governance3.png": 209,
	"./Project/assets/grants-background.png": 165,
	"./Project/assets/grants1.svg": 147,
	"./Project/assets/hero-background.png": 166,
	"./Project/assets/history-mobile.svg": 67,
	"./Project/assets/history.svg": 68,
	"./Project/assets/oliver_solo.png": 210,
	"./Project/assets/project1.svg": 148,
	"./Project/assets/project2.svg": 149,
	"./Project/assets/project3.png": 211,
	"./Project/assets/quote-bg1.jpg": 212,
	"./Project/assets/quote-bg2.jpg": 213,
	"./Project/assets/roadmap-background.png": 167,
	"./Project/assets/speech.svg": 69,
	"./Project/assets/videothumbnail.png": 168,
	"./Project/assets/yalda_sola.png": 214,
	"./index": 8,
	"./index.js": 8
};
...
var _Governance = __webpack_require__(106);

var _Governance2 = _interopRequireDefault(_Governance);

var _Grants = __webpack_require__(107);

var _Grants2 = _interopRequireDefault(_Grants);

var _Contribute = __webpack_require__(108);

var _Contribute2 = _interopRequireDefault(_Contribute);

var _Roadmap = __webpack_require__(109);

var _Roadmap2 = _interopRequireDefault(_Roadmap);

var _Blog = __webpack_require__(110);

var _Blog2 = _interopRequireDefault(_Blog);

var _Aracon = __webpack_require__(111);

var _Aracon2 = _interopRequireDefault(_Aracon);

var _Wiki = __webpack_require__(112);
...
var SecondaryNavbar = function SecondaryNavbar(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        InternalItem,
        { className: page && page === 'roadmap' ? 'active roadmap-item' : 'roadmap-item', to: '/project/roadmap' },
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 16 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
var _Zoom = __webpack_require__(152);

var _Zoom2 = _interopRequireDefault(_Zoom);

var _reactYoutube = __webpack_require__(153);
...
var Entry = function Entry(_ref) {
  var children = _ref.children,
      ...
      lastpoint = _ref.lastpoint;
  return _react2.default.createElement(
    EntryBox,
    null,
    entrypoint && _react2.default.createElement('div', { className: 'entry-point' }),
    lastpoint && _react2.default.createElement('div', { className: 'last-point' }),
    _react2.default.createElement(
      'div',
      { className: 'content' },
      children
...
var EntryBox = _styledComponents2.default.div(_templateObject, medium('left: -34px;'), medium('left: -40.5px;'), medium('width: 100%;'));
...
var Content = _styledComponents2.default.div(_templateObject, large('margin-top: 30px;'));
...
var _reactSpring = __webpack_require__(13);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onScroll = function (event) {
    ...
    var image = 1 - document.scrollingElement.scrollTop * 2 / 1000;
    ...
    var height = 1 - document.scrollingElement.scrollTop * 2 / 1000;
...
var _SidePanel = __webpack_require__(23);
...
module.exports = "data:image/svg+xml;base64,"
...
var _logoFooter = __webpack_require__(27);
...
var _forum = __webpack_require__(116);

var _forum2 = _interopRequireDefault(_forum);

var _rocket = __webpack_require__(30);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('img', { src: _rocket2.default })
          ),
          _react2.default.createElement(
            'a',
          ...
          _react2.default.createElement(
            'a',
            {
              ...
              target: '_blank' },
            _react2.default.createElement(Youtube, { src: _youtube2.default })
          )
        ),
        _react2.default.createElement(
          'p',
...
var Youtube = _styledComponents2.default.img(_templateObject6);
var LogoImg = _styledComponents2.default.img(_templateObject7);
...
module.exports = "data:image/svg+xml;base64,"
...
var _homeVideo = __webpack_require__(33);

var _homeVideo2 = _interopRequireDefault(_homeVideo);

var _videoMobile = __webpack_require__(34);

var _videoMobile2 = _interopRequireDefault(_videoMobile);

var _blur = __webpack_require__(117);

var _blur2 = _interopRequireDefault(_blur);

var _poster = __webpack_require__(35);
...
var VideoContainer = _styledComponents2.default.div(_templateObject);

var Blur = _styledComponents2.default.img(_templateObject2);
var VideoDesktop = _styledComponents2.default.video(_templateObject3, medium('width: auto; margin-left: 28px;'));

var HeroSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject4);
var Box = _styledComponents2.default.div(_templateObject5, medium('flex-direction: row; margin: auto;'));
var TextContainer = _styledComponents2.default.div(_templateObject6, medium('min-width: 453px;'), medium('text-align: left;'), medium('text-align: left; margin-top: 15px;'), medium('text-align: left;'));
...
module.exports = __webpack_require__.p + "static/025a70f2-video-mobile.mp4";

/***/ }),
/* 35 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/f2082061-poster.jpg";
...
var _LongCard = __webpack_require__(6);
...
var bellaContent = _react2.default.createElement(
  _reactStatic.Link,
  { to: '/bella' },
  _react2.default.createElement(
    'p',
...
var About = function About() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      Container,
      null,
      _react2.default.createElement(_LongCard2.default, {
        linkTo: '/bella',
...
var feature1 = _react2.default.createElement(
  'span',
  null,
  _react2.default.createElement(
    'p',
    null,
    'Click on any address to assign it a name. Then you will always see that name across all Aragon apps. You can export your names and send them to other people in your organization.'
  )
);
var feature2 = _react2.default.createElement(
  'span',
  null,
  _react2.default.createElement(
    'p',
    null,
    'The activity center keeps you informed about the status of your pending transactions.'
  )
);
var feature3 = _react2.default.createElement(
  'span',
  null,
  _react2.default.createElement(
    'p',
    null,
    'Add an employee, their salary and tokens allowed to withdraw. That\u2019s it. For real. Employees get their payroll whenever they prefer. Weekly? Daily? In real time? It\u2019s up to them now.'
  )
);
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 39 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 44 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 45 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/8479581d-stage3.svg";

/***/ }),
/* 46 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 47 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
module.exports = __webpack_require__.p + "static/41d267fc-althea.svg";
...
module.exports = __webpack_require__.p + "static/754ce234-dapp.svg";

/***/ }),
/* 52 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 53 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/78386080-governance.svg";

/***/ }),
/* 54 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/438d5093-hero-bg.svg";

/***/ }),
/* 55 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/a42b105a-hero-mobile.svg";

/***/ }),
/* 56 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 57 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
module.exports = __webpack_require__.p + "static/2f132806-pando.svg";

/***/ }),
/* 60 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/ac3e0022-pre-footer.svg";

/***/ }),
/* 61 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 62 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/0b0836c7-security.svg";

/***/ }),
/* 63 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/3881c84d-transparency.svg";

/***/ }),
/* 64 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 65 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
module.exports = __webpack_require__.p + "static/3229e446-history.svg";

/***/ }),
/* 69 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
var feature4 = _react2.default.createElement(
  'span',
  null,
  _react2.default.createElement(
    'p',
    null,
    'All your saved names stay only on your device. App upgrades are always opt-in. Aragon organizations are sovereign, and we want them to stay that way.'
  )
);

var LastFeatures = function LastFeatures() {
  return _react2.default.createElement(
    _Section2.default,
    null,
    _react2.default.createElement(
...
var feature1 = _react2.default.createElement(
  ...
  _react2.default.createElement(
    'p',
    null,
    'A few years ago, could you ever imagine running a company from your phone? \u2028Vote, check finances and always be informed about your organizations. Anywhere, just a tap away.'
  )
);
var feature2 = _react2.default.createElement(
  'span',
  ...
  _react2.default.createElement(
    'p',
    null,
    'Thanks to the new App Center, you can seamlessly upgrade apps in your organization. Enhancements and security fixes constantly make your organization better.'
  )
);
...
var _promoVideo = __webpack_require__(150);

var _promoVideo2 = _interopRequireDefault(_promoVideo);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('source', { src: _promoVideo2.default, type: 'video/mp4' })
          )
        ),
        _react2.default.createElement(
          'h2',
        ...
        _react2.default.createElement(
          'h4',
          null,
          'Aragon empowers you to freely organize and collaborate. Create global, bureaucracy-free organizations, companies, and communities.'
        ),
        _react2.default.createElement(
          _ui.Button.Anchor,
          { className: 'hero-link', mode: 'strong', href: 'https://mainnet.aragon.org/' },
          'Try Bella now'
        )
      ),
      _react2.default.createElement(
...
var VideoeSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject);
var Box = _styledComponents2.default.div(_templateObject2, large('flex-direction: row;'), medium('margin-top: 30px; max-width: 70%;'), large('max-width: 56%;'));
var Container = _styledComponents2.default.div(_templateObject3, large('text-align: left; margin: inherit; padding-right: 30px;'), large('text-align: left;'), large('text-align: left;'));
...
var _videoBackground = __webpack_require__(151);
...
var _VideoModal = __webpack_require__(17);
...
var VideoeSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject, _videoBackground2.default);
var Box = _styledComponents2.default.div(_templateObject2, medium('flex-direction: row;'));
var Container = _styledComponents2.default.div(_templateObject3, medium('text-align: left; margin: inherit;'));
var Image = _styledComponents2.default.img(_templateObject4);

var Modal = _styledComponents2.default.div(_templateObject5);
...
var BlogPost = function BlogPost() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      Container,
      null,
      _react2.default.createElement(MariasPost, {
...
var _discoverVideo = __webpack_require__(155);

var _discoverVideo2 = _interopRequireDefault(_discoverVideo);
...
var VideoMobile = _styledComponents2.default.video(_templateObject2);

var VideoDesktop = _styledComponents2.default.video(_templateObject3, medium('width: auto; margin-right: 70px;'));

var HeroSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject4);
var Box = _styledComponents2.default.div(_templateObject5, medium('flex-direction: row; margin: auto; justify-content: space-between;'));
...
var _unstoppableOrgBackground = __webpack_require__(156);

var _unstoppableOrgBackground2 = _interopRequireDefault(_unstoppableOrgBackground);

var _unstoppableOrg = __webpack_require__(40);
...
var QuoteContainer = _styledComponents2.default.div(_templateObject, function (props) {
  return props.background && 'background-image: url(' + props.background + ');';
}, medium('padding: 0;'));
var Box = _styledComponents2.default.div(_templateObject2, medium('flex-direction: row;'), medium('width: 460px;'), medium('margin-top: 0;'), medium('height: 570px;'));
...
var _what = __webpack_require__(48);
...
var _hero = __webpack_require__(157);
...
var HeroSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject, _hero2.default);
...
var _buy = __webpack_require__(158);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        Box,
        null,
        _react2.default.createElement('img', { src: _create2.default }),
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(
      ...
      _react2.default.createElement(
        Box,
        null,
        _react2.default.createElement('img', { src: _buy2.default }),
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(
...
var _TimelineContainer = __webpack_require__(85);
...
var _stage3 = __webpack_require__(44);

var _stage4 = _interopRequireDefault(_stage3);

var _stage5 = __webpack_require__(45);

var _stage6 = _interopRequireDefault(_stage5);

var _stage7 = __webpack_require__(46);

var _stage8 = _interopRequireDefault(_stage7);

var _stage9 = __webpack_require__(47);

var _stage10 = _interopRequireDefault(_stage9);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          Box,
          null,
          _react2.default.createElement('img', { src: _stage2.default }),
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          Box,
          null,
          _react2.default.createElement('img', { src: _stage4.default }),
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          Box,
          null,
          _react2.default.createElement('img', { src: _stage6.default }),
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          Box,
          null,
          _react2.default.createElement('img', { src: _stage8.default }),
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
...
var TimelineContainer = _styledComponents2.default.div(_templateObject, medium('padding: 5px 50px;'), medium('left: 41px;'));
...
var _logoFooter = __webpack_require__(56);

var _logoFooter2 = _interopRequireDefault(_logoFooter);

var _twitter = __webpack_require__(64);

var _twitter2 = _interopRequireDefault(_twitter);

var _ghost = __webpack_require__(52);

var _ghost2 = _interopRequireDefault(_ghost);

var _forum = __webpack_require__(161);

var _forum2 = _interopRequireDefault(_forum);

var _rocket = __webpack_require__(61);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: 'https://aragon.org/discover', target: '_blank' },
          'Discover'
        ),
        _react2.default.createElement(
          'a',
          { href: 'https://aragon.org/project', target: '_blank' },
          'Project'
        ),
        _react2.default.createElement(
          'a',
          { href: 'https://aragon.org/network', target: '_blank' },
          'Network'
        )
      ),
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: 'https://aragon.org/project/grants', target: '_blank' },
          'Grants'
        ),
        _react2.default.createElement(
          'a',
          { href: 'https://aragon.org/prroject/governance', target: '_blank' },
          'Governance'
        )
      ),
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: 'https://aragon.org/project/contribute', target: '_blank' },
          'Contribute'
        ),
        _react2.default.createElement(
          'a',
...
var Container = _styledComponents2.default.div(_templateObject2, medium('grid-template-columns: 16.66% 16.66% 16.66% 16.66% 30.32%;'));
...
var _governance = __webpack_require__(53);
...
var ImageContainer = _styledComponents2.default.div(_templateObject, medium('height: 720px;'));

var GovernanceSection = _styledComponents2.default.section(_templateObject2, medium('flex-direction: row;'));

var TextBox = _styledComponents2.default.div(_templateObject3, medium('padding: 30px 70px; align-items: flex-end;'), medium('text-align: right;'), medium('font-size: 48px;'), medium('text-align: right;'));
...
var _heroBg = __webpack_require__(54);

var _heroBg2 = _interopRequireDefault(_heroBg);

var _heroMobile = __webpack_require__(55);
...
var HeroSection = _styledComponents2.default.section(_templateObject, _heroBg2.default, _heroMobile2.default, medium('height: 47vw; background-size: contain;'));

var Container = _styledComponents2.default.div(_templateObject2, medium('padding-top: 200px;'));
exports.default = Hero;
...
var Navbar = function (_React$Component) {
  ...
  _createClass(Navbar, [{
    ...
    key: 'render',
    value: function render() {
      var menuItems = [['https://aragon.org/discover', 'Discover'], ['https://hack.aragon.org/', 'Developers'], ['https://aragon.org/project', 'Project'], ['https://aragon.org/network', 'Network']];
      return _react2.default.createElement(
        _reactSpring.Spring,
        {
          from: { x: 0, h: 64, i: 44 },
...
var _SidePanel = __webpack_require__(93);
...
var _preFooter = __webpack_require__(60);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: 'https://wiki.aragon.org/design/powered_by_aragon/', target: '_blank' },
          'Learn more'
        )
      )
    )
...
var PreFooterSection = _styledComponents2.default.section(_templateObject, _preFooter2.default);

var Container = _styledComponents2.default.div(_templateObject2, medium('font-size: 48px; margin-top: 110px!important;'), medium('padding-top: 200px;'));
...
var _pando = __webpack_require__(59);

var _pando2 = _interopRequireDefault(_pando);

var _althea = __webpack_require__(49);

var _althea2 = _interopRequireDefault(_althea);

var _dapp = __webpack_require__(51);

var _dapp2 = _interopRequireDefault(_dapp);

var _melonport = __webpack_require__(57);
...
var _security = __webpack_require__(62);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            'The smart contracts have been audited by the Whitehat group, ConsenSys Diligence, and Authio'
          )
        )
      )
    )
...
var SecuritySection = _styledComponents2.default.section(_templateObject2, medium('flex-direction: row;'));

var TextBox = _styledComponents2.default.div(_templateObject3, medium('padding: 30px 70px;'), medium('font-size: 48px;'), medium('font-size: 32px;'));
...
var _transparency = __webpack_require__(63);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h2',
            null,
            'Actions are public and transparent by default'
          )
        )
      )
    )
...
var TransparencySection = _styledComponents2.default.section(_templateObject2, medium('flex-direction: row;'));

var TextBox = _styledComponents2.default.div(_templateObject3, medium('padding: 30px 70px;'), medium('font-size: 48px;'));
...
var _historyMobile = __webpack_require__(67);
...
var HistoryImage = _styledComponents2.default.img(_templateObject);
var Label = _styledComponents2.default.div(_templateObject2);
var DateBox = _styledComponents2.default.div(_templateObject3);

var Container = _styledComponents2.default.div(_templateObject4, medium('grid-template-columns: calc(50% - 15px) calc(50% - 15px); grid-template-rows: 500px 500px 500px'));
...
var AragonClient = function (_React$Component) {
  _inherits(AragonClient, _React$Component);

  function AragonClient(props) {
    _classCallCheck(this, AragonClient);

    var _this = _possibleConstructorReturn(this, (AragonClient.__proto__ || Object.getPrototypeOf(AragonClient)).call(this, props));
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_ui.DropDown, {
          ...
          _react2.default.createElement(
            ...
            (this.state.active == 0 || this.state.active == 1) && _react2.default.createElement(
              _Entry2.default,
              null,
              _react2.default.createElement(
                Module,
            ...
            (this.state.active == 0 || this.state.active == 2) && _react2.default.createElement(
              _Entry2.default,
              null,
              _react2.default.createElement(
                Module,
            ...
            _react2.default.createElement(_Entry2.default, { lastpoint: true })
          )
        )
      );
    }
...
var DropdownContainer = _styledComponents2.default.div(_templateObject, medium('width: calc(100% - 207px);'), medium('flex-direction: row;'), medium('width: calc(100% - 207px);'));
var RoadmapContainer = _styledComponents2.default.div(_templateObject2, medium('padding: 5px 50px;'), medium('left: 21px;'));

var AragonOneBadge = (0, _styledComponents2.default)(_ui.Badge)(_templateObject3);
var StyledBadge = (0, _styledComponents2.default)(_ui.Badge)(_templateObject4);

var AutarkBadge = (0, _styledComponents2.default)(_ui.Badge)(_templateObject5);

var RoadmapSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject6);
var Container = _styledComponents2.default.div(_templateObject7, medium('padding: 50px 8.5%;'));

var Title = _styledComponents2.default.h1(_templateObject8);

var Subtitle = _styledComponents2.default.h6(_templateObject9);

var Module = _styledComponents2.default.div(_templateObject10);

exports.default = AragonClient;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h4',
              null,
              'Allow people to delegate their voting power to delegates (i.e. representatives) who can vote on their behalf and continue experimenting with new voting mechanisms.'
            )
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h4',
              null,
              'Provides a secure foundation for managing collateral deposits for agreements while allowing collateral assets to be used in to participate in governance.'
            )
          )
        ),
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h4',
              null,
              'Improve the experience and scalability of voting by implementing a protocol for votes to be submitted to a set of bonded relayers.'
            )
          )
        ),
        _react2.default.createElement(_Entry2.default, { lastpoint: true })
...
var EnhancedBadge = (0, _styledComponents2.default)(_ui.Badge)(_templateObject);

var RoadmapContainer = _styledComponents2.default.div(_templateObject2, medium('padding: 5px 50px;'), medium('left: 21px;'));

var AragonOneBadge = (0, _styledComponents2.default)(_ui.Badge)(_templateObject3);

var AutarkBadge = (0, _styledComponents2.default)(_ui.Badge)(_templateObject4);

var RoadmapSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject5);
var Container = _styledComponents2.default.div(_templateObject6, medium('padding: 50px 8.5%;'));

var Title = _styledComponents2.default.h1(_templateObject7);

var Subtitle = _styledComponents2.default.h6(_templateObject8);

var Module = _styledComponents2.default.div(_templateObject9);
...
var _association = __webpack_require__(66);
...
var _speech = __webpack_require__(69);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ImageContainer,
          null,
          _react2.default.createElement('img', { src: _speech2.default, alt: 'feedback' })
        ),
        _react2.default.createElement(
          'div',
          null,
...
var StyledSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject);
var Container = _styledComponents2.default.div(_templateObject2, (0, _ui.breakpoint)('medium', '\n    grid-template-columns: calc(50% - 15px) calc(50% - 15px);\n    grid-template-rows: auto\n  '));

var Feedback = _styledComponents2.default.div(_templateObject3, (0, _ui.breakpoint)('medium', '\n    padding: 30px 15px;\n    grid-column-end: 3;\n    flex-direction: row;\n  '), large('padding: 30px 60px;'), medium('font-size: 46px;'));
var ImageContainer = _styledComponents2.default.div(_templateObject4, medium('width: 50%;'));
...
var QuoteSection = _styledComponents2.default.section(_templateObject);
...
var Svg = function Svg() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "g",
      { id: "roadmap" },
      _react2.default.createElement("path", { className: "white", fill: "#fff", id: "Path", d: "M7.42675 4.31322C7.42956 2.46509 5.96895 0.919515 4.05775 0.748237C2.14655 0.576959 0.414774 1.83644 0.0632826 3.65332C-0.288208 5.4702 0.856449 7.24555 2.70352 7.74831V13.7977C1.10539 14.2319 0.00171437 15.6359 0.00171437 17.2347C0.00171437 18.8335 1.10539 20.2375 2.70352 20.6717V26.7172C0.919743 27.2027 -0.218878 28.8806 0.0356666 30.6485C0.290212 32.4163 1.85994 33.7327 3.71362 33.7327C5.56731 33.7327 7.13704 32.4163 7.39158 30.6485C7.64612 28.8806 6.5075 27.2027 4.72372 26.7172V20.6679C6.32186 20.2337 7.42553 18.8296 7.42553 17.2308C7.42553 15.632 6.32186 14.228 4.72372 13.7938V7.7522C6.32144 7.31595 7.42477 5.91222 7.42675 4.31322Z" }),
      _react2.default.createElement("rect", { className: "white", fill: "#fff", x: "10.2994", y: "0.985718", width: "29.4949", height: "8", rx: "1" }),
      _react2.default.createElement("rect", { x: "10.2994", y: "13.5", width: "29.4949", height: "8", rx: "1", className: "white", fill: "#fff" }),
      _react2.default.createElement("rect", { x: "10.2994", y: "26", width: "29.4949", height: "8", rx: "1", className: "white", fill: "#fff" })
    )
  );
};
...
module.exports = __webpack_require__.p + "static/63d09d57-blur2.png";
...
module.exports = __webpack_require__.p + "static/653833af-7.svg";

/***/ }),
/* 125 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNTY3IiBoZWlnaHQ9IjQ0MiIgdmlld0JveD0iMCAwIDU2NyAzODIiIGZpbGw9Im5vbmUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+Cgo8L3N2Zz4K"

/***/ }),
/* 126 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/a436d3bf-hello.svg";
...
module.exports = __webpack_require__.p + "static/47760763-fight-background.svg";
...
module.exports = __webpack_require__.p + "static/68945552-promo-video.mp4";

/***/ }),
/* 151 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/2a296233-video-background.png";
...
module.exports = __webpack_require__.p + "static/07b748be-hero-background.jpg";

/***/ }),
/* 155 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/64be05cb-discover-video.mp4";
...
module.exports = __webpack_require__.p + "static/46b5cf5a-hero.png";

/***/ }),
/* 158 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/cbfff09a-buy.png";

/***/ }),
/* 159 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/81ede301-create.png";
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "static/c9e060de-videothumbnail.png";
...
var _UnstoppableOranizations = __webpack_require__(78);

var _UnstoppableOranizations2 = _interopRequireDefault(_UnstoppableOranizations);

var _Hero = __webpack_require__(76);

var _Hero2 = _interopRequireDefault(_Hero);

var _BlogPost = __webpack_require__(75);
...
var _Association = __webpack_require__(101);

var _Association2 = _interopRequireDefault(_Association);

var _heroBackground = __webpack_require__(166);
...
var _videothumbnail = __webpack_require__(168);
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { target: '_blank', href: 'https://www.youtube.com/watch?v=AqjIWmiAidw' },
                  _react2.default.createElement('img', { src: _videothumbnail2.default })
                )
              ),
              _react2.default.createElement(
                _ui.BreakPoint,
                { from: 'medium' },
                _react2.default.createElement('img', { src: _videothumbnail2.default, onClick: this.handleOpen }),
...
var HeroSection = (0, _styledComponents2.default)(_Section2.default)(_templateObject, medium('height: 550px;'), _heroBackground2.default, medium('margin-left: 20px;'));
var Box = _styledComponents2.default.div(_templateObject2, medium('flex-direction: row;'));
...
var _governanceBackground = __webpack_require__(164);
...
var _Hero = __webpack_require__(82);
...
var _grantsBackground = __webpack_require__(165);

var _grantsBackground2 = _interopRequireDefault(_grantsBackground);

var _GrantsContent = __webpack_require__(104);

var _GrantsContent2 = _interopRequireDefault(_GrantsContent);

var _GrantsQuotes = __webpack_require__(105);
...
var _ContributeContent = __webpack_require__(102);
...
var _communityBackground = __webpack_require__(163);
...
var _AragonClient = __webpack_require__(99);

var _AragonClient2 = _interopRequireDefault(_AragonClient);

var _AragonNetwork = __webpack_require__(100);

var _AragonNetwork2 = _interopRequireDefault(_AragonNetwork);

var _FeedbackModule = __webpack_require__(103);
...
var _roadmapBackground = __webpack_require__(167);

var _roadmapBackground2 = _interopRequireDefault(_roadmapBackground);
...
var Roadmap = function (_React$Component) {
  _inherits(Roadmap, _React$Component);
  ...
  function Roadmap() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Roadmap.__proto__ || Object.getPrototypeOf(Roadmap)).call.apply(_ref, [this].concat(args))), _this), _this.state = { active: 'left' }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Roadmap, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_SecondaryNavbar2.default, { page: 'roadmap' }),
        _react2.default.createElement(
          Hero,
          null,
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.setState({ active: 'left' });
              } },
            'Aragon Client'
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.setState({ active: 'right' });
              } },
            'Aragon Network'
          )
        ),
        active === 'left' ? _react2.default.createElement(_AragonClient2.default, null) : _react2.default.createElement(_AragonNetwork2.default, null),
...
var Tabs = _styledComponents2.default.div(_templateObject);

var Hero = (0, _styledComponents2.default)(_Section2.default)(_templateObject2, _roadmapBackground2.default);
...
var _NetworkContent = __webpack_require__(86);
...
var _networkBackground = __webpack_require__(160);
...
var _heroBackground = __webpack_require__(154);

var _heroBackground2 = _interopRequireDefault(_heroBackground);

var _heroTitle = __webpack_require__(15);

var _heroTitle2 = _interopRequireDefault(_heroTitle);

var _arrow = __webpack_require__(38);

var _arrow2 = _interopRequireDefault(_arrow);

var _Features = __webpack_require__(37);

var _Features2 = _interopRequireDefault(_Features);

var _MoreFeatures = __webpack_require__(71);

var _MoreFeatures2 = _interopRequireDefault(_MoreFeatures);

var _LastFeatures = __webpack_require__(70);

var _LastFeatures2 = _interopRequireDefault(_LastFeatures);

var _Video = __webpack_require__(73);

var _Video2 = _interopRequireDefault(_Video);

var _TryBella = __webpack_require__(72);
...
var _Pulse = __webpack_require__(215);
...
var Bella = function (_React$Component) {
  _inherits(Bella, _React$Component);

  function Bella() {
    _classCallCheck(this, Bella);

    return _possibleConstructorReturn(this, (Bella.__proto__ || Object.getPrototypeOf(Bella)).apply(this, arguments));
  }
  ...
  _createClass(Bella, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Fade2.default,
              { duration: 3000 },
              _react2.default.createElement('img', { src: _heroTitle2.default })
            )
          ),
          _react2.default.createElement(
            Discover,
        ...
        _react2.default.createElement(_MoreFeatures2.default, null),
        _react2.default.createElement(_LastFeatures2.default, null),
        _react2.default.createElement(_TryBella2.default, null)
      );
    }
  }]);
...
var _Transparency = __webpack_require__(97);

var _Transparency2 = _interopRequireDefault(_Transparency);

var _Governance = __webpack_require__(88);

var _Governance2 = _interopRequireDefault(_Governance);

var _Security = __webpack_require__(96);

var _Security2 = _interopRequireDefault(_Security);

var _Projects = __webpack_require__(95);
...
var _PreFooter = __webpack_require__(94);
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_Hero2.default, null),
        _react2.default.createElement(_Transparency2.default, null),
        _react2.default.createElement(_Governance2.default, null),
        _react2.default.createElement(_Security2.default, null),
        _react2.default.createElement(_Projects2.default, null),
        _react2.default.createElement(_PreFooter2.default, null),
...
var HomeContainer = _styledComponents2.default.div(_templateObject, medium('line-height: 1;'), medium('padding: 0;'));
exports.default = Home;
...
var _reactStaticRoutes = __webpack_require__(183);
...
var _path2 = __webpack_require__(184);

var _path3 = _interopRequireDefault(_path2);

var _importCss2 = __webpack_require__(185);

var _importCss3 = _interopRequireDefault(_importCss2);

var _universalImport2 = __webpack_require__(186);
...
var _reactUniversalComponent = __webpack_require__(188);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/pages/Home',
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 115)), (0, _importCss3.default)('src/pages/Home', {
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 169)), (0, _importCss3.default)('src/pages/Discover', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 170)), (0, _importCss3.default)('src/pages/Project', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 171)), (0, _importCss3.default)('src/pages/Governance', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 172)), (0, _importCss3.default)('src/pages/Grants', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 173)), (0, _importCss3.default)('src/pages/Contribute', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 174)), (0, _importCss3.default)('src/pages/Roadmap', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 175)), (0, _importCss3.default)('src/pages/Network', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_8 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 176)), (0, _importCss3.default)('src/pages/Bella', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/Bella');
  },
  resolve: function resolve() {
    return /*require.resolve*/(176);
  },
  chunkName: function chunkName() {
    return 'src/pages/Bella';
  }
}), universalOptions);
var t_9 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 177)), (0, _importCss3.default)('src/pages/PoweredByAragon', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/PoweredByAragon');
  },
  resolve: function resolve() {
    return /*require.resolve*/(177);
  },
  chunkName: function chunkName() {
    return 'src/pages/PoweredByAragon';
  }
}), universalOptions);
var t_10 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Library/WebServer/Documents/delfi/delfi-aragon-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 178)), (0, _importCss3.default)('src/pages/NotFound', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var _requireUniversalModule = __webpack_require__(189);
...
var _reportChunks = __webpack_require__(190);
...
module.exports = __webpack_require__.p + "static/d9b92860-background-1.png";

/***/ }),
/* 194 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/61062bce-background-2.png";

/***/ }),
/* 195 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/621319d3-background-3.png";

/***/ }),
/* 196 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/62288abe-bg_2.png";
...
module.exports = __webpack_require__.p + "static/e0f8a8a2-blur.png";
...
module.exports = __webpack_require__.p + "static/cd2f575f-poster.png";
